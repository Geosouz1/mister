...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Mister</b>PIZZARIA</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Tela de entrada</p>

      <?php
                echo form_open('mister', ['class' => 'form-signin']);
                echo $error;
                $this->session->unset_userdata('error');
                ?>
    
      <div class="form-group has-feedback">
          <input name="username" id="username" type="input" class="form-control" placeholder="Nome" required>
